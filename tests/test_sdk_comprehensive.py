...
class TestDeviceIntegrations:
    ...
    def test_device_factory(self):
        ...
        for device_type in cgm_types:
            ...
            assert isinstance(
                device, DeviceFactory.DEVICE_TYPES[device_type.lower().replace(" ", "_")]
            )
...
class TestDatasets:
    ...
    def test_synthetic_data_generation(self, dataset_manager):
        ...
        data = dataset_manager.load_synthetic_cgm(n_patients=5, days=7, sampling_rate="5T")
    ...
    def test_data_preparation(self, dataset_manager):
        ...
        X, y = dataset_manager.prepare_for_training(data, lookback_hours=4, horizon_minutes=30)
...
class TestPerformance:
    ...
    async def test_batch_predictions(self, optimizer):
        ...
        # Create test batch
        batch_data = [
            {"glucose_history": np.random.normal(120, 20, 48).tolist()} for _ in range(50)
        ]
...
class TestBenchmarks:
    ...
    def test_batch_processing_benchmark(self, benchmark):
        ...
        data = [{"glucose_history": np.random.normal(120, 20, 48).tolist()} for _ in range(100)]
