...
class DemoScenarios:
    ...
    def meal_optimization():
        ...
        return {"peak_reduction": 77, "time_in_range_improvement": 35}  # mg/dL  # %
    ...
    def generate_clinical_trial_results(n_patients: int = 1000):
        ...
        results = {
            ...
            "primary_outcomes": {
                ...
                "hba1c": {"baseline": 7.8, "with_sdk": 7.1, "reduction": 0.7, "p_value": 0.0003},
            },
            "safety_outcomes": {
                "severe_hypoglycemia": {
                    "baseline_events": 142,
                ...
                "dka_events": {"baseline": 23, "with_sdk": 8, "reduction_percent": 65.2},
            },
            "quality_of_life": {
                "diabetes_distress_score": {"baseline": 3.8, "with_sdk": 2.1, "improvement": 44.7},
                "treatment_satisfaction": {"baseline": 62, "with_sdk": 89, "improvement": 43.5},
            },
            "economic_impact": {
...
async def run_full_demo():
    ...
    print(
        f"   • Severe Hypos: -{results['safety_outcomes']['severe_hypoglycemia']['reduction_percent']}%"
    )
