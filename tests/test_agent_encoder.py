...
def test_encoder_encode_list_input(encoder):
    glucose_list = [100.0, 105.0, 110.0, 115.0, 120.0, 118.0, 115.0, 110.0, 105.0, 100.0, 95.0, 90.0]
...
def test_encoder_encode_numpy_1d_input(encoder):
    glucose_np_1d = np.array([100.0, 105.0, 110.0, 115.0, 120.0, 118.0, 115.0, 110.0, 105.0, 100.0, 95.0, 90.0])
...
def test_encoder_encode_numpy_2d_row_vector_input(encoder):
    glucose_np_2d_row = np.array([[100.0, 105.0, 110.0, 115.0, 120.0, 118.0, 115.0, 110.0, 105.0, 100.0, 95.0, 90.0]])
...
def test_encoder_encode_numpy_2d_col_vector_input(encoder):
    glucose_np_2d_col = np.array([[100.0], [105.0], [110.0], [115.0], [120.0], [118.0], 
...
def test_encode_consistency(encoder):
    ...
    assert np.array_equal(embedding1, embedding2), "Embeddings for the same input are not consistent"
...
def test_encode_different_inputs_different_embeddings(encoder):
    ...
    assert not np.array_equal(embedding1, embedding2), "Embeddings for different inputs are identical"
