...
def plot_predictions(
    ...
    if confidence_intervals is not None:
        ...
        ax.fill_between(x, lower, upper, alpha=0.3, color="red", label="Διάστημα εμπιστοσύνης")
...
def plot_training_history(
    history: Dict, title: str = "Ιστορικό Εκπαίδευσης", figsize: Tuple[int, int] = (12, 5)
) -> plt.Figure:
    """
...
def plot_time_in_range(
    tir_results: Dict, title: str = "Time in Range Ανάλυση", figsize: Tuple[int, int] = (10, 6)
) -> plt.Figure:
    """
    ...
    values = [
        tir_results["very_low_percent"],
        tir_results["low_percent"],
        tir_results["in_range_percent"],
        tir_results["high_percent"],
...
def plot_metrics_comparison(
    metrics_dict: Dict, title: str = "Σύγκριση Μετρικών", figsize: Tuple[int, int] = (12, 8)
) -> plt.Figure:
    """
...
def create_dashboard(
    ...
    title: str = "Dashboard Ψηφιακού Διδύμου",
) -> plt.Figure:
    """
    ...
    ax_info.text(
        0.1, 0.9, model_info, transform=ax_info.transAxes, fontsize=10, verticalalignment="top"
    )
