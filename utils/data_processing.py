...
def clean_cgm_data(data: pd.DataFrame, 
                  glucose_col: str = 'cgm',
...
def calculate_glucose_statistics(data: pd.DataFrame,
                                glucose_col: str = 'cgm') -> Dict:
    """
...
def detect_meal_events(data: pd.DataFrame,
                      glucose_col: str = 'cgm',
                      threshold: float = 20,
