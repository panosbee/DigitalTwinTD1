...
class RealTimeDashboard:
        ...
        self.app.layout = html.Div([
            ...
            html.Div([
                html.Div([
                    ...
                    html.P("Real-time glucose monitoring powered by AI", className="subtitle")
    ...
    def _create_glucose_chart(self, prediction_obj: Optional[Prediction] = None): # Use imported Prediction
        ...
        # Generate time axis
        now = datetime.now()
        times = [now - timedelta(minutes=5*i) for i in range(len(self.glucose_history)-1, -1, -1)]
    ...
    def _create_pattern_chart(self):
        ...
        hours = list(range(24))
        avg_glucose = [
            100, 95, 90, 88, 87, 90, 95, 110, 140, 135,
            125, 120, 130, 145, 140, 130, 125, 135, 150,
            145, 130, 120, 110, 105
        ]
